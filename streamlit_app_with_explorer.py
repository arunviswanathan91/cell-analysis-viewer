...
<style>
    ...
    * {
    ...
    /* ========== GLASSMORPHISM CAR🔬 - Premium Look ========== */
...
def render_signature_survival():
    ...
    **p-value:** {sig_row['hr_p']:.3e}
    ...
    if generate:
        ...
        if len(patient_data) < 30:
            st.warning(f"âš ï¸ Insufficient data (n={len(patient_data)}, need ≥30)")
            return
...
def main():
    ...
    **Genes:** {len(genes)}
    ...
    if generate:
        ...
        # Tab 2: Ridge Plot
        with tabs[1]:
            st.markdown("### 🗺️  Posterior Distribution Visualization")
            ...
            st.markdown("#### 🗺️  Overlapped Posterior Distributions")
